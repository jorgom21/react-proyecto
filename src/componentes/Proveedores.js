                            ...
                            <div class="modal-body">
                                ...
                                <div class="container mt-4">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label for="cantidad" class="form-label">Nit</label>
                                            <input type="number" class="form-control" id="nit" placeholder="Ingrese el nit" required/>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nombre: Proveedor 1</p>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Nombre: Proveedor 2</p>
